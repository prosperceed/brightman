...
const Address = () => {
  return (
    <div className="address__card max-w-[20rem] mx-auto h-[27rem] bg-cyan-400 rounded-lg shadow-lg drop-shadow-lg shadow-black">
      <div className="card">
        <div className="card__details">
          <div className="flex flex-col py-12 gap-6 ">
            ...
            <h4 className="text-gray-200 flex mx-5 mt-5 items-center break-words gap-2">
